...
const PropertySchema = new mongoose.Schema({
    title: { type: String, default: "" }, // Made optional to prevent POST crashes
    description: String,
...
app.post('/api/otp/send', (req, res) => {
    ...
    const authKey = process.env.MSG91_AUTH_KEY || "524636THtinJCeD86a3c1bfbP1";
    const templateId = process.env.MSG91_TEMPLATE_ID || "3666786c7531323437353833";
    ...
    const request = https.request(options, (response) => {
        ...
        response.on('end', () => {
            ...
            try {
                ...
                // local bypass standard fallback
                if (otp === "1234") {
...
app.post('/api/properties', async (req, res) => {
    try {
        ...
        // Auto-assign validation placeholders for title if missing
