...
// संशोधित कनेक्शन (बिना अनुपयोगी ऑप्शंस के)
...
app.post('/api/send-whatsapp-share', async (req, res) => {
    ...
    const TEMPLATE_NAME = "property_detail_share"; // आपके अप्रूव्ड टेम्पलेट का सही नाम

    // आवश्यक पैरामीटर्स की जांच
    ...
    try {
        ...
        const payload = {
            ...
            template: {
                name: TEMPLATE_NAME,
                language: {
                    code: "en_US" // यदि हिंदी टेम्पलेट है तो"hi" का प्रयोग करें
                },
                components: [
                    {
                        type: "header",
                    ...
                    },
                    {
                        type: "body",
                        parameters: [
                            { type: "text", text: customerName || "Customer" }, // Variable {{1}}
                            { type: "text", text: bhkType || "Premium" },       // Variable {{2}}
                            { type: "text", text: locality || "Bhopal" }        // Variable {{3}}
                        ]
                    },
                    {
                        type: "button",
                        ...
                        parameters: [
                            {
                                type: "text",
                                text: `?property=${propertyId}` // Variable जो Base URL (mamadealing.com/) के अंत में जुड़ेगा
                            }
                        ]
                    }
                ]
