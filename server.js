...
// 4. DELETE Property (For Seller Inventory Management)
app.delete('/api/properties/:id', async (req, res) => {
    try {
        ...
        res.status(200).json({ message: "✅ Property successfully delete ho gayi!" });
    } catch (error) {
        res.status(500).json({ message: "❌ Server error in deleting property", error: error.message });
    }
});
