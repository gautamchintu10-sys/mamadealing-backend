...
// 🌐 DNS FIX: Google DNS फ़ोर्स करें ताकि MongoDB Atlas SRV आसानी से कनेक्ट हो सके
try {
    dns.setDefaultResultOrder('ipv4first');
    dns.setServers(['8.8.8.8', '8.8.4.4']);
} catch (e) {
    console.warn("DNS override warning:", e.message);
}
...
// ==========================================
// 🚀 METADATA INJECTION ROUTE (रिच प्रीव्यू के लिए अनुकूलित)
// ==========================================
