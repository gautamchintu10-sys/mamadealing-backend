...
function switchTab(tabId) {
    // मोबाइल व्यू में यदि लॉगिन नहीं है और वे प्रोफाइल क्लिक करते हैं तो डायरेक्ट लॉगिन खोलें
...
async function triggerOtpRequestSequence() {
    ...
    if (otpContainer.classList.contains('hidden')) {
        ...
        if (window.verifyOTP && typeof window.verifyOTP === 'function') {
            try {
